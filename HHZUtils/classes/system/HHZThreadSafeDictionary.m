//
//  HHZThreadSafeDictionary.m
//  iOS-HHZUniversal
//
//  Created by 陈哲#376811578@qq.com on 2017/1/5.
...
@implementation HHZThreadSafeDictionary
{
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:HHZThreadSafeDictionary.class]) {
        HHZThreadSafeDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:HHZThreadSafeDictionary.class]) {
        HHZThreadSafeDictionary *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
        isEqual = [_dic isEqual:other->_dic];
